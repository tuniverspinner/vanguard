...
description: "An introduction to Vanguard, your AI-powered development assistant in VS Code."
---

Vanguard is an open source AI coding agent that brings frontier AI models directly to your VS Code editor. Unlike autocomplete tools, Vanguard is a true coding agent that can understand entire codebases, plan complex changes, and execute multi-step tasks.

## Open Source AI Coding, Uncompromised

Vanguard gives you direct, transparent access to frontier AI with no limits, no surprises, and no model ecosystem lock-in. See every decision. Choose any model. Control your costs.

### Complete Transparency

Watch in real-time as Vanguard reads files, considers approaches, and proposes changes. Every decision is visible, every edit reviewable before it's made. This isn't just "explainable AI" - it's complete transparency.
...
Vanguard explores your codebase and works with you to create comprehensive plans before writing a single line of code, ensuring it understands the full context of your project.

**Plan Mode** for complex tasks - Vanguard explores, asks questions, and creates detailed implementation plans.

**Act Mode** for execution - Vanguard implements the plan with full transparency and control.
